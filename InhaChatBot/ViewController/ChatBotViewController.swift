...
class ChatBotViewController: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        // Register observer Notification을 받았을때 didBecomeActive를 동작함. name은 받고자하는 알림의 이름
...
//    }
    ...
    // Method to instantiate assistant service //어시스턴트 서비스 시작하기위한 메소드
...
//            self.stopAnimating()
    ...
    // Watson과 User 이미지 수정하는 부분
    func getAvatarFor(sender: Sender) -> Avatar {
        switch sender {
        case current:
            return Avatar(image: UIImage(named: "user"), initials: "GR")
        case watson:
...
extension ChatBotViewController: MessageLabelDelegate {
...
extension ChatBotViewController: MessageInputBarDelegate {
